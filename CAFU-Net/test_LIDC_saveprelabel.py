...
def parse_args():
    ...
    parser.add_argument('--name', default="UNET",
                        help='model name: UNET',choices=['UNET', 'SAR_UNet', "UNet2P",'UNet3P', 'swinunet', 'UCTransNet',"resunetpp"
                                                         ...
                                                         ,"Unet_Conformer","Unet_CFFM_Conformer","Paranet","UNet1","UNet2","UNet3","UNet4_no_SD","UNet5_no_SG",
                                                         "UNet6_no_S","UNet7_no_G","DATransUNet", "BRAUnet"])
...
# img_dir = 'liuzhou_datasets/img_npy'  #原始图片npy
# label_dir = 'liuzhou_datasets/label'  #原始标签
...
model.load_state_dict(torch.load(('checpoint/liuzhou_LIDC/{}_base/best.pth').format(config["name"])))
model.cuda()
